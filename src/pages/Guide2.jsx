...
export default function Guide2({person, setNumPage}) {
  const [currentStep, setCurrentStep] = useState(0);

  const [lang, setLang] = useContext(LngContext);

  const pages = [
    <GuideFirstStep lang={lang} lc={person.lang} />,
    <GuideSecondStep lang={lang} lc={person.lang} />,
    <GuideFifthStep lang={lang} lc={person.lang} />,
    <GuideThirdStep lang={lang} lc={person.lang} />,
    <GuideSevenStep lang={lang} lc={person.lang} />,
    <GuideFourthStep lang={lang} lc={person.lang} />,
    <GuideSixthStep lang={lang} lc={person.lang} />,
  ];
  ...
  return (
    <div className="flex flex-col py-[20px] h-full overlow">
      ...
      <div className="px-[10px]">
        ...
        >
          {currentStep === pages.length - 1 ? lang?.guid?.ingame_button[person.lang] : lang?.guid?.next_button[person.lang]}
        </button>
      </div>
    </div>
  );
