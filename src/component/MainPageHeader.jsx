...
import { allLanguages } from "../helper/languages";
...
function MainPageHeader({setNumPage, person, setLangSelectOpen}) {
  return (
    <div className="flex flex-row w-full gap-[7px]">
      ...
      <button onClick={() => setNumPage(8)} className="flex flex-row items-center justify-between gap-[10px] mb-[25px] elem-bg_green py-[7px] px-[10px] rounded-[10px]">
